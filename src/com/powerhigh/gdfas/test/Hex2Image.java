...
public class Hex2Image {
	 public static void main(String[] args) throws Exception  
	    {  
	        ...
	        InputStream is = new FileInputStream("D:/apache-tomcat-7.0.73/webapps/ROOT/ep_photo/317.txt");  
...
//	            System.out.println(str);  
	        ...
	        to.saveToImgFile(sb.toString().toUpperCase(), "D:/apache-tomcat-7.0.73/webapps/ROOT/ep_photo/317.jpg");  
	    }  
